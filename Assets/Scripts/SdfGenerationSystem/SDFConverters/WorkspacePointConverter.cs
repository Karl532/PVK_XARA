...
using UnityEngine;
    ...
    public sealed class WorkspacePointConverter : IDisposable
    {
        ...
        public void EnsureCapacity(int maxPoints)
        {
            ...
            DebugService.LogVerbose($"[WorkspacePointConverter] Allocated buffers for {_capacity} points.");
        }
        ...
        public void Dispose()
        {
            ...
            _countBuffer = null;
            _capacity = 0;
            DebugService.LogVerbose("[WorkspacePointConverter] Disposed buffers.");
        }
    }
